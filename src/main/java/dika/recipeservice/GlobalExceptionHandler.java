...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(
        ...
        String errorMessage = "Validation failed for fields: " + validationErrors.keySet();
